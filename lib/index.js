...
class Flowifier {
    ...
    async executeWorkflow(workflowId, contextObj) {
        ...
        // 2) Prepare Request
        const body = {
            name: 'JavaScript Client Library',
            context: contextObj
        }
     ...
     * @param {string} workflowId the workflow identifier for the requested workflow instace.
     * @param {string} workflowInstanceId the workflow instance identifier.
     * @returns {string} the workflow instance status.
     * @throws {Error} if the request to the Flowifier API failed.
     */
    async getWorkflowInstanceStatus(workflowId, workflowInstanceId) {
        // 1) Build Uri
        const uri = `${this.appUrl}/api/v1/organizations/${this.organizationId}/workflows/${workflowId}/instances/${workflowInstanceId}`
     ...
     * @throws {Error} if the request to the Flowifier API failed.
     */
    async getWorkflowInstanceResult(workflowId, workflowInstanceId) {
        // 1) Build Uri
        const uri = `${this.appUrl}/api/v1/organizations/${this.organizationId}/workflows/${workflowId}/instances/${workflowInstanceId}/result`
